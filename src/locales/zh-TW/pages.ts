export default {
  ...
  'pages.login.accountLogin.tab': '電子郵件登入',
  'pages.login.accountLogin.errorMessage': '錯誤的電子郵件與密碼',
  'pages.login.failure': '登錄失敗，請重試！',
  'pages.login.success': '登錄成功！',
  'pages.login.email.placeholder': '電子郵件: user@example.com',
  'pages.login.email.required': '電子郵件為必填項！',
  'pages.login.email.invalid': '電子郵件格式不正確！',
  ...
  'pages.login.googleLogin': '使用 Google 登入',
  'pages.login.google.success': 'Google 登入成功！',
  'pages.login.firebase.configMissing': 'Firebase 設定缺失，請聯絡管理員。',
  'pages.login.firebase.invalidCredential': '憑證無效，請檢查電子郵件與密碼。',
  'pages.login.firebase.invalidEmail': '電子郵件格式不正確。',
  'pages.login.firebase.userDisabled': '此帳號已被停用，請聯絡管理員。',
  'pages.login.firebase.userNotFound': '找不到符合的帳號。',
  'pages.login.firebase.popupClosed': '登入流程已取消。',
  'pages.login.firebase.popupCancelled': '已有登入請求處理中，請稍後重試。',
